          ...
          {filterButtons.map((filter, index) => (
            <button
              ...
              style={{
                ...
                color: activeFilter === filter.value ? '#2196F3' : '#666',
                cursor: 'pointer',
                ...
                <div key={session._id} style={{
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      {(session.developerId?.firstName?.[0] || '') + (session.developerId?.lastName?.[0] || '')}
                    </div>
                    <div>
                      <div style={{ fontWeight: '500' }}>
                        {session.developerId?.firstName} {session.developerId?.lastName}
                      </div>
